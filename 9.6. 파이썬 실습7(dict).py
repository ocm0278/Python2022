...
+'You can write programs for many reasons ranging from making your living to solving a difficult data analysisproblem to having fun to helping someone else solve a problem'+
       ...
       'we only knew the language to speak to explain to the computer what we would like it to do next.'+
       'If we knew this language we could tell the computer to do tasks on our behalf that were repetitive.')

x=word1.split(' ')
for word in x :
    word7[word]=word7.get(word,0)+1
print(word7)
